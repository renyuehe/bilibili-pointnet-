...
if __name__ == '__main__':
    ...
    TEST_DATASET = PartNormalDataset(root=r"E:\Desktop\网课pointnet++\Pointnet_Pointnet2_pytorch\data\shapenetcore_partanno_segmentation_benchmark_v0_normal", npoints=50, split='test', normal_channel=False)
    point_set = TEST_DATASET[300]
    points = point_set[0]
    im_array = point_cloud_three_views(points)
    img = Image.fromarray(np.uint8(im_array * 255.0))
    img.save('example.jpg')
